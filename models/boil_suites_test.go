...
func TestToOne(t *testing.T) {
	...
	t.Run("DiscordMessageEmbedToDiscordMessageRevisionUsingRevision", testDiscordMessageEmbedToOneDiscordMessageRevisionUsingRevision)
}
...
func TestToMany(t *testing.T) {
	...
	t.Run("DiscordMessageRevisionToRevisionDiscordMessageEmbeds", testDiscordMessageRevisionToManyRevisionDiscordMessageEmbeds)
}
...
func TestToOneSet(t *testing.T) {
	...
	t.Run("DiscordMessageEmbedToDiscordMessageRevisionUsingRevision", testDiscordMessageEmbedToOneSetOpDiscordMessageRevisionUsingRevision)
}

// TestToOneRemove tests cannot be run in parallel
// or deadlocks can occur.
func TestToOneRemove(t *testing.T) {
	t.Run("DiscordMessageEmbedToDiscordMessageUsingMessage", testDiscordMessageEmbedToOneRemoveOpDiscordMessageUsingMessage)
	t.Run("DiscordMessageEmbedToDiscordMessageRevisionUsingRevision", testDiscordMessageEmbedToOneRemoveOpDiscordMessageRevisionUsingRevision)
}
...
func TestToManyAdd(t *testing.T) {
	...
	t.Run("DiscordMessageRevisionToRevisionDiscordMessageEmbeds", testDiscordMessageRevisionToManyAddOpRevisionDiscordMessageEmbeds)
}

// TestToManySet tests cannot be run in parallel
// or deadlocks can occur.
func TestToManySet(t *testing.T) {
	t.Run("DiscordMessageToMessageDiscordMessageEmbeds", testDiscordMessageToManySetOpMessageDiscordMessageEmbeds)
	t.Run("DiscordMessageRevisionToRevisionDiscordMessageEmbeds", testDiscordMessageRevisionToManySetOpRevisionDiscordMessageEmbeds)
}

// TestToManyRemove tests cannot be run in parallel
// or deadlocks can occur.
func TestToManyRemove(t *testing.T) {
	t.Run("DiscordMessageToMessageDiscordMessageEmbeds", testDiscordMessageToManyRemoveOpMessageDiscordMessageEmbeds)
	t.Run("DiscordMessageRevisionToRevisionDiscordMessageEmbeds", testDiscordMessageRevisionToManyRemoveOpRevisionDiscordMessageEmbeds)
}
